            ...
            <div class="lg:col-span-5 space-y-6 order-2 lg:order-1">
                ...
                <a href="<?php echo esc_url(get_theme_mod('github_url', '#')); ?>" class="flex items-center justify-between p-6 bg-surface-darkest border border-border hover:border-primary transition-all group rtl">
                    ...
                    <div class="flex items-center gap-4">
                        <span class="text-sm font-bold text-white uppercase tracking-widest">GitHub / <?php echo esc_attr(get_theme_mod('github_handle', 'danialchoopan')); ?></span>
                    </div>
                </a>
                <?php endif; ?>
                ...
                <div class="bg-surface-darkest border border-border p-8 md:p-12 text-right rtl">
                    ...
                    <form id="portfolio-contact-form" class="space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-2">
                                <label class="text-[10px] font-black uppercase tracking-widest text-zinc-500 block"><?php echo esc_html( get_theme_mod( 'contact_name_label', 'نام شما' ) ); ?>__</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-[10px] font-black uppercase tracking-widest text-zinc-500 block"><?php echo esc_html( get_theme_mod( 'contact_email_label', 'ایمیل' ) ); ?>__</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-zinc-500 block"><?php echo esc_html( get_theme_mod( 'contact_subject_label', 'موضوع' ) ); ?>__</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-zinc-500 block"><?php echo esc_html( get_theme_mod( 'contact_message_label', 'پیام' ) ); ?>__</label>
