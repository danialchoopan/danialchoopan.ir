<section class="py-24 bg-surface-darkest">
    <div class="container mx-auto px-6">
        <div class="flex flex-col items-end mb-16 text-right rtl">
            <span class="text-[10px] font-black uppercase tracking-[0.3em] text-primary mb-4"><?php echo esc_html(get_theme_mod('tech_section_subtitle', 'خدمات ما')); ?></span>
            <h2 class="text-4xl md:text-5xl font-black text-white tracking-tighter"><?php echo esc_html(get_theme_mod('tech_section_title', 'پکیج‌های تخصصی')); ?></h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            $packages = [
                [
                    'title' => get_theme_mod('service_1_title', 'Studio Live'),
                    'desc' => get_theme_mod('service_1_desc', 'مشاوره و کدنویسی زنده با تیم فنی برای حل چالش‌های پیچیده در لحظه.'),
                ...
                [
                    'title' => get_theme_mod('service_2_title', 'Projects'),
                    'desc' => get_theme_mod('service_2_desc', 'اجرای پروژه‌های صفر تا صد وب و موبایل با بالاترین استانداردهای روز دنیا.'),
                ...
                [
                    'title' => get_theme_mod('service_3_title', 'Pro Corner'),
                    'desc' => get_theme_mod('service_3_desc', 'منتورینگ اختصاصی برای توسعه‌دهندگانی که می‌خواهند به سطح ارشد برسند.'),
                    'tags' => ['COACHING', 'MENTORSHIP'],
                    'icon' => '<path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>'
                ],
                [
                    'title' => get_theme_mod('service_4_title', 'Assignment Helper'),
                    'desc' => get_theme_mod('service_4_desc', 'همیار فنی برای انجام پروژه‌های دانشگاهی و چالش‌های تخصصی استخدامی.'),
                ...
                <div class="group p-8 bg-surface border border-border hover:border-primary transition-all duration-500 text-right rtl">
                    <div class="w-12 h-12 bg-surface-high border border-border flex items-center justify-center mb-8 group-hover:bg-primary group-hover:text-surface transition-colors">
                        <svg class="w-6 h-6 text-primary group-hover:text-surface" fill="currentColor" viewBox="0 0 24 24">
                            <?php echo wp_kses( $pkg['icon'], [ 'path' => [ 'd' => [] ] ] ); ?>
                        </svg>
                    </div>

                    <h3 class="text-2xl font-black text-white mb-4 tracking-tight"><?php echo esc_html($pkg['title']); ?></h3>
