		...
		<div class="container mx-auto px-6 relative z-10">
			<div class="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
				<div class="col-span-1 md:col-span-2">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="text-xl font-black mb-8 inline-block tracking-tighter text-white">
					...
					<div class="flex gap-6">
						...
						?>
						<a href="<?php echo esc_url($github_url); ?>" class="text-zinc-500 hover:text-white transition-colors">
						...
						<a href="<?php echo esc_url($linkedin_url); ?>" class="text-zinc-500 hover:text-white transition-colors">
			...
			<div class="pt-8 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-6">
				<p class="text-zinc-700 text-[10px] font-black uppercase tracking-widest">
					&copy; <?php echo esc_html( date( 'Y' ) ); ?> <?php bloginfo( 'name' ); ?>. <span class="mx-2 opacity-30">|</span> <?php esc_html_e( 'Hand-crafted for performance', 'devportfolio' ); ?>
				</p>
			</div>
		</div>
	</footer>
